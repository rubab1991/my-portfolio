...
export default function Hero() {
  return (
    ...
    <div
      id="hero"
      className="min-h-screen container mx-auto sm:flex flex-col sm:justify-center bg-no-repeat bg-left bg-cover sm:p-6 md:p-20"
      style={{ backgroundImage: "url('/images/background.png')"  }} // Optional: use if you need a background image
    >

    
      <div className="sm:flex sm:items-center sm:justify-between max-w-6xl mx-auto w-full">
        {/* Profile Image */}
        ...
        <div className="ml-6" data-aos="fade-up-right">
          <p className="msm:text-4xl md:text-8xl font-serif font-extrabold text-white">I am Rubab Bukhari</p>
          {/* eslint-disable-next-line react/no-unescaped-entities */}
          <p className="sm:text-lg md:text-xl font-semibold mt-4 text-white">
