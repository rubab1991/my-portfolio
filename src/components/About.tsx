export default function About() {
    return (
      <div id="about" className="bg-black font-bold p-10 md:p-20 sm:text-lg md:text-2xl" data-aos="flip-left">
        <p className="sm:text-2xl md:text-4xl text-white font-bold md:font-extrabold py-6">About Me</p>
